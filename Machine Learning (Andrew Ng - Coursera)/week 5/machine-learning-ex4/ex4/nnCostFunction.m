...
Theta2_Reg = Theta2;
Theta2_Reg(:,1) = 0;
J = 1.0/m * sum(sum(-Y.*log(a3)-(1-Y).*log(1-a3))) + lambda/(2.0*m)*(sum(sum(Theta1_Reg.*Theta1_Reg))+ sum(sum(Theta2_Reg.*Theta2_Reg)));
delta_3 = (a3 - Y);
...
% -------------------------------------------------------------
Theta1_grad = 1.0/m * Theta1_grad + lambda/m*Theta1_Reg;
Theta2_grad = 1.0/m * Theta2_grad + lambda/m*Theta2_Reg;
% =========================================================================
